...
const Header = () => {
  return (
    <header className="z-10 relative mt-[12%] text-custom-light flex flex-col md:flex-row flex-col-reverse justify-between items-center">
      <div className="md:w-[40%] w-full">
        <span className="text-[14px] mb-[2px]">Software Engineer</span>
        <h1 className="leading-[60px] font-bold md:text-[52px] sm:text-[42px] text-[36px] tracking-[4px] mb-[4px]">
          Hello I'm <span className="text-custom-primary">Rian Mandala</span>
        </h1>
      ...
      <div className="relative md:m-0 mb-[60px]">
